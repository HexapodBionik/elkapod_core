...
class PitchDemo(Node):
    def __init__(self):
        super().__init__("pitch_demo")
        self._publisher = self.create_publisher(Float64, "/pitch_setpoint", 10)

        self._roll_setpoints_deg = [0.0, 2.0, 6.0, 4.0, 3.0, 0.0, 0.0, -2.0, -6.0, -4.0, -3.0, 0.0, 0.0]
        ...
        self.get_logger().info("Pitch demo node started!")
