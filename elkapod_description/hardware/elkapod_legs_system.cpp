...
bool ElkapodLegsSystemHardware::on_init_validate_interfaces(
    const hardware_interface::HardwareInfo& info) {
  for (const hardware_interface::ComponentInfo& joint : info.joints) {
    if (joint.command_interfaces.size() != 1) {
      RCLCPP_FATAL(rclcpp::get_logger("ElkapodLegsSystemHardware"),
...
ElkapodLegsSystemHardware::export_state_interfaces() {
...
ElkapodLegsSystemHardware::export_command_interfaces() {
...
hardware_interface::return_type ElkapodLegsSystemHardware::read(const rclcpp::Time& /*time*/,
...
PLUGINLIB_EXPORT_CLASS(elkapod_legs_system::ElkapodLegsSystemHardware,
